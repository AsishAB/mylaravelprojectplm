          ...
          <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                ...
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <form method="post" id="login_form" action="{{ url('login_attempt') }}" autocomplete="off">
                      @csrf
                    <div class="row px-3"> 
                      ...
                      <label class="mb-1">
                        ...
                        <input class="mb-4" type="text" id="login_email" placeholder="Email/Username" name="login_email">
...
<div class="jumbotron" id="important_msg">
  <h1 class="text-danger">Please set APP_DEBUG = true in the .env file </h1>
  <p>This message will vanish in 10 seconds</p>
</div >
<script type="text/javascript">
  ...
  setTimeout(function(){ $('#important_msg').hide(); }, 10000);
